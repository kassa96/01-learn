...
def on_progress0(stream, chunk, bytes_remaining):
    total_size = stream.filesize
    bytes_downloaded = total_size - bytes_remaining
    percentage = (bytes_downloaded / total_size) * 100
    print(f"Downloading... {percentage:.2f}%")

def download_video0(url, output_dir, callback=None):
    try:
        ...
        # Rename downloaded file with video ID
        default_filename = video.default_filename
        extension = os.path.splitext(default_filename)[1]  # Get file extension
